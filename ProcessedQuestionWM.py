...
class ProcessedQuestionWM:
    def __init__(self, question, model, useStemmer = False, useSynonyms = False, removeStopwords = False):
        self.model = model
    ...
    def getQueryVector(self, searchQuery):
        ...
        # TODO: Iterate through the searchQuery
